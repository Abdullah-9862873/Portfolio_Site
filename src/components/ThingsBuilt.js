      ...
      <div className={" block md:hidden"}>
        ...
        >
          ...
          <div className="px-4 pt-4">
            ...
            <div className="text-[12px] text-[#ccd6f6] font-customMono mt-2">
              Next.js React TypeScript Zustand Node.js Tesseract.js PyPDF Mammoth Gemini 2.5 Flash
            </div>
            <div className="flex gap-4 mt-2">
              <a
                target="_blank"
      ...
      <div className={" hidden md:block"}>
        ...
        >
          <div class="project-content2 text-left text-[13px] text-[#64ffda] font-customMono bg-transparent antialiased">
            ...
            <ul class="bg-transparent text-[13px] text-[#a8b2d1] font-customMono text-left">
              <li>Next.js TypeScript CSS FastAPI Groq Pinecone Sentence Transformers</li>
            </ul>
        ...
        >
          <div class="project-content text-right text-[13px] text-[#64ffda] font-customMono bg-transparent antialiased ">
            ...
            <ul class="bg-transparent text-[13px] text-[#a8b2d1] font-customMono text-right tbScreen27:pr-[41px]">
              <li>Next.js Node.js TypeScript React PyPDF</li>
            </ul>
            <div className="tbScreen27:pr-[41px]">
              <a
        ...
        >
          ...
          <div class="project-content text-right text-[13px] text-[#64ffda] font-customMono bg-transparent antialiased ">
            ...
            <ul class="bg-transparent text-[13px] text-[#a8b2d1] font-customMono text-right tbScreen27:pr-[41px]">
              <li>Next.js React TypeScript Zustand Node.js Tesseract.js PyPDF Mammoth Gemini 2.5 Flash</li>
            </ul>
            <div className="tbScreen27:pr-[41px]">
              <a
        ...
        >
          <div class="project-content2 text-left text-[13px] text-[#64ffda] font-customMono bg-transparent antialiased">
            ...
            <ul class="bg-transparent text-[13px] text-[#a8b2d1] font-customMono text-left">
              <li>Next.js React TypeScript FastAPI Python OpenAI GPT APIs Speech Recognition</li>
            </ul>
            <div className="tbScreen27:pr-[41px]">
              <a
